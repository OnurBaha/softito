...
function App() {
  ...
  return (
    <>
      <div className="p-4 md:p-6 bg-gry-100 min-h-screen">
        <div className="border border-gray-200 rounded-2xl bg-white overflow-hidden shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 min-h-\[600px]">
            <div className="border border-r border-gray-200 bg-gray-50">
          ...
          <div className="p-4 col-span-1 md:col-span-3 bg-white">
