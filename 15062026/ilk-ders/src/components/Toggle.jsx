...
function Toggle() {
  ...
  return (
    <div className='p-4'>
        <h4 className='demo-title text-xl font-bold'>Demo 2: Mantıksal (boolean) State Yönetimi</h4>
            ...
            <div className="space-y-4">
                <div>
                    ...
                    <div className="relative">
                        ...
                        <button type='button' onClick={sifreToggle} className='btn-password-toggle'>{sifreGoster ? "Gizle" : "Göster"}</button>
                    </div>
                </div>
                <div className= "demo-state-info">
                    <strong>Durum Bilgisi</strong>
                    <ul className="demo-info-list">
                        <li>Gece Mode: <code>{geceModu ? "Açık (true)" : "Kapalı (false)"}</code></li>
