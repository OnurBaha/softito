  ...
  return (
    ...
    <footer className="footer">
        <div className="footer-container">
            ...
            <div className="footer-section">
                <h3 className="footer-title">Telefon</h3>
            ...
            <div className="footer-section">
                ...
                <span className="footer-link">İade ve Değişimi</span>
            </div>
            <div className="footer-section">
                <h3 className="footer-title">Güvenli Alışveriş</h3>
                <p className="text-xs text-gray-500">%100 güvenli ödeme altyapısı ile kart bilgileriniz korunmaktadır</p>
            </div>
            <div className="footer-bottom">
                <p>@2026 Onur Baha Koç -    Tüm Hakları Saklıdır.</p>
            </div>
        </div>
    </footer>
    </>
