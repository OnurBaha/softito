  ...
  return (
    <div className="space-y-xl">
      <section className="mt-lg">
        ...
        <p className="text-body-md">Bugün ne öğrenmek isteriz?</p>
      </section>

      <section>
        <div className="seacrh-bar-wrapper">
        ...
        <div className="hero-card block">
          <div className="hero-overlay">
            ...
            <div className="hero-text-container">
              ...
              <h3 className="text-display-lg mt-2">UI/UX Tasarım Temelleri</h3>
              <p className="hero-description">
                Profesyonel Tasarımcı olmak için gereken her şey burada.
              </p>
        ...
        <div className="courses-scroll-container no-scrollbar">
          <div className="course-card">
            ...
            <div className="course-card-info">
              ...
              <p className="course-card-author">Selahaddin Çiftçi</p>
              <div className="course-card-rating-row">
                ...
                <span className="text-caption text-outline">(2859)</span>
              </div>
