        ...
        <div className="flex-container">
          ...
          <div className="card-alert-container">
            ...
            <p className="alert-text">
              <strong>{customerToDelete.name}</strong> isimli müşteriyi silmek istediğinize
              emin misiniz? Bu işlem geri alınamaz.
            </p>
            <div className="flex-actions">
              <button type="button" className="btn-danger flex-1" onClick={handleConfirmDelete}>
                Evet, Sil
              </button>
              <button type="button" className="btn-secondary flex-1" onClick={()=>setCustomerToDelete(null)}>
                Vazgeç
              </button>
            </div>
          </div>
